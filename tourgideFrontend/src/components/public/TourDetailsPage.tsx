...
import { Home, List, User, Briefcase, LogIn, UserPlus, BookOpen, Repeat, Star, PlusCircle, Edit, Trash2, Eye, MapPin, DollarSign, Award, Book } from 'lucide-react';
...
const TourDetailsPage = ({ tourId, onNavigate }) => {
  ...
  const { url, tourInView } = useContext(StoreContext);
        ...
        <div style={{width:'max(60%,330px)', margin:'auto'}} className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-10">
              ...
              <button className="flex-1 bg-purple-600 text-white py-4 rounded-xl font-semibold text-xl hover:bg-purple-700 transition duration-300 shadow-lg transform hover:scale-105 flex items-center justify-center">
